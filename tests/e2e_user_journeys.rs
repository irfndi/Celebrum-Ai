...
impl E2ETestFramework {
    pub async fn new() -> Self {
        ...
        let user_profile_service = UserProfileService::new(
            arb_edge::services::kv_store::KvStore::new(),
            d1_service.clone(),
    ...
    pub async fn create_test_user(&mut self, 
        ...
        let user_profile = UserProfile {
            ...
            telegram_user_id: Some(12345 + self.test_users.len() as i64),
        ...
        // Store user profile
        self.user_profile_service.create_user_profile(&user_profile).await?;
    ...
    pub async fn simulate_market_update(&mut self) -> Result<Vec<TradingOpportunity>, ArbitrageError> {
        ...
        let opportunity = TradingOpportunity {
            id: "test_opportunity_1".to_string(),
...
mod e2e_user_journey_tests {
    ...
    async fn test_complete_new_user_journey() {
        ...
        assert!(opportunities[0].profit_potential > 0.0, "Should have profit potential");
