...
72. In docs/PRD.md between lines 264 and 325, the subscription pricing model lacks
...
73. In src/services/opportunity_enhanced.rs around lines 430 to 450, the volatility
...
74. In src/services/notifications.rs around lines 470 to 484, the current rate
...
75. In src/services/notifications.rs at line 263, the call to
...
76. In src/services/notifications.rs around lines 329 to 335, the current check for
...
77. In src/services/ai_intelligence.rs around lines 803 to 810, the method currently
...
78. In src/services/ai_intelligence.rs around lines 275 to 282, the variable
...
79. In src/services/ai_intelligence.rs around lines 256 to 272, the exchange_data is
...
80. In src/services/ai_intelligence.rs around lines 199 to 209, the variable
...
81. In src/services/user_trading_preferences.rs around lines 327 to 344, the current
...
82. In src/services/d1_database.rs around lines 164 to 184, the
