...
impl InlineKeyboard {
    ...
    async fn check_user_permission_static(
        ...
        // Convert UserProfile to UserPermissions for permission checking
        let permissions = UserPermissions {
            role: user_profile.access_level.clone(),
            subscription_tier: user_profile.subscription.tier.tier(),
            daily_opportunity_limit: user_profile.subscription.daily_opportunity_limit.unwrap_or(3),
            ...
            can_trade: user_profile.has_trading_api_keys(),
        };

        // Check permission using the existing UserProfile method
    ...
    pub fn create_main_menu() -> Self {
        ...
        // Row 6: Profile and Settings (available to all users)
        keyboard.add_row(vec![
            InlineKeyboardButton::new("👤 Profile", "profile"),
