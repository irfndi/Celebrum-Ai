...
impl D1Service {
    ...
    pub async fn get_user_opportunity_preferences(
        ...
        Option<crate::services::opportunity_categorization::UserOpportunityPreferences>,
    > {
        let stmt = self.db.prepare(
    ...
    pub async fn store_balance_history(
        &self,
        entry: &crate::services::fund_monitoring::BalanceHistoryEntry,
    ) -> ArbitrageResult<()> {
    ...
    fn row_to_balance_history(
        &self,
        row: HashMap<String, Value>,
    ) -> ArbitrageResult<crate::services::fund_monitoring::BalanceHistoryEntry> {
    ...
    pub async fn store_config_template(
        &self,
        template: &crate::services::dynamic_config::DynamicConfigTemplate,
    ) -> ArbitrageResult<()> {
    ...
    pub async fn store_config_preset(
        &self,
        preset: &crate::services::dynamic_config::ConfigPreset,
    ) -> ArbitrageResult<()> {
        let stmt = self.db.prepare(
            "
    ...
    pub async fn store_user_config_instance(
        &self,
        instance: &crate::services::dynamic_config::UserConfigInstance,
    ) -> ArbitrageResult<()> {
        let stmt = self.db.prepare(
            "
    ...
    pub async fn store_notification_template(
        &self,
        template: &crate::services::notifications::NotificationTemplate,
    ) -> ArbitrageResult<()> {
        let stmt = self.db.prepare(
            "
    ...
    pub async fn get_notification_template(
        &self,
        template_id: &str,
    ) -> ArbitrageResult<Option<crate::services::notifications::NotificationTemplate>> {
        let stmt = self.db.prepare(
    ...
    pub async fn store_alert_trigger(
        &self,
        trigger: &crate::services::notifications::AlertTrigger,
    ) -> ArbitrageResult<()> {
        let stmt = self.db.prepare(
            "
    ...
    pub async fn get_user_alert_triggers(
        &self,
        user_id: &str,
    ) -> ArbitrageResult<Vec<crate::services::notifications::AlertTrigger>> {
        let stmt = self.db.prepare(
            "
    ...
    pub async fn store_notification_history(
        &self,
        history: &crate::services::notifications::NotificationHistory,
    ) -> ArbitrageResult<()> {
        let stmt = self.db.prepare(
            "
    ...
    pub async fn get_user_notification_history(
        ...
        user_id: &str,
        limit: Option<i32>,
    ) -> ArbitrageResult<Vec<crate::services::notifications::NotificationHistory>> {
    ...
    fn row_to_trading_preferences(
        ...
        let trading_focus: crate::services::user_trading_preferences::TradingFocus =
        ...
        let experience_level: crate::services::user_trading_preferences::ExperienceLevel =
        ...
        let risk_tolerance: crate::services::user_trading_preferences::RiskTolerance =
        ...
        let automation_level: crate::services::user_trading_preferences::AutomationLevel =
        ...
        let automation_scope: crate::services::user_trading_preferences::AutomationScope =
    ...
    fn row_to_notification_template(
        &self,
        row: HashMap<String, Value>,
    ) -> ArbitrageResult<crate::services::notifications::NotificationTemplate> {
    ...
    fn row_to_alert_trigger(
        &self,
        row: HashMap<String, Value>,
    ) -> ArbitrageResult<crate::services::notifications::AlertTrigger> {
    ...
    fn row_to_notification_history(
        &self,
        row: HashMap<String, Value>,
    ) -> ArbitrageResult<crate::services::notifications::NotificationHistory> {
    ...
    pub async fn store_ai_opportunity_enhancement(
        &self,
        enhancement: &crate::services::ai_intelligence::AiOpportunityEnhancement,
    ) -> ArbitrageResult<()> {
    ...
    pub async fn store_ai_portfolio_analysis(
        &self,
        analysis: &crate::services::ai_intelligence::AiPortfolioAnalysis,
    ) -> ArbitrageResult<()> {
    ...
    pub async fn store_ai_performance_insights(
        &self,
        insights: &crate::services::ai_intelligence::AiPerformanceInsights,
    ) -> ArbitrageResult<()> {
    ...
    pub async fn store_ai_parameter_suggestion(
        &self,
        user_id: &str,
        suggestion: &crate::services::ai_intelligence::ParameterSuggestion,
    ) -> ArbitrageResult<()> {
    ...
    pub async fn get_ai_opportunity_enhancements(
        ...
        user_id: &str,
        limit: Option<i32>,
    ) -> ArbitrageResult<Vec<crate::services::ai_intelligence::AiOpportunityEnhancement>> {
    ...
    pub async fn get_ai_performance_insights(
        ...
        user_id: &str,
        limit: Option<i32>,
    ) -> ArbitrageResult<Vec<crate::services::ai_intelligence::AiPerformanceInsights>> {
