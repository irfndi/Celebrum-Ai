...
impl MessageHandler {
    ...
    pub fn format_opportunity_message(&self, opportunity: &Value) -> ArbitrageResult<String> {
    ...
    pub fn format_user_profile_message(&self, profile: &Value) -> ArbitrageResult<String> {
