...
#[cfg(test)]
mod tests {
    // Test helper functions moved to packages/worker/tests/ai/ai_beta_integration_test.rs

    // Tests moved to packages/worker/tests/ai/ai_beta_integration_test.rs
}
