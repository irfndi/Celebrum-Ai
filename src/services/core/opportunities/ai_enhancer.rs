...
#[cfg(test)]
mod tests {
    // Test helper functions moved to packages/worker/tests/opportunities/ai_enhancer_test.rs

    // Tests have been moved to packages/worker/tests/opportunities/ai_enhancer_test.rs
}
